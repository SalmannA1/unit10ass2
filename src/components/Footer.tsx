        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-bold">Hot Beans Web</h3>
            </div>
            <p className="text-gray-400 mb-4">
              Building exceptional web experiences and nurturing the next generation of web developers.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span>123 Tech Street, Digital City, DC4 5TE</span>
              </li>
              <li className="flex items-start">
              ...
              <li className="flex items-start">
                ...
                <span>careers@hotbeansweb.com</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#jobs" className="text-gray-400 hover:text-white transition-colors">Job Openings</a></li>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">Subscribe to our newsletter for the latest job openings and web development resources.</p>
